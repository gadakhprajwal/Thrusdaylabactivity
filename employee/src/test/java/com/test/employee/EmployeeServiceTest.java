...
public class EmployeeServiceTest {
	...
	{
		//way 1
	//	employeeService.addEmployee(123,"Riya",25000,"pune","india");
		//employeeService.addEmployee(124,"Siya",30000,"pune","india");
		...
		Employee emp=Employee.builder().empId(123).
				name("Riya").salary(25000).address(add).build();
	...
	void testDisplayByEmpId() throws GlobalException{
		...
		void testRemoveById()
		{
			...
			//assertEquals("Riya", employeeService.findId(101).getName());
		...
		{
			Address add=Address.builder().city("pune").country("india").build();
			Employee emp=Employee.builder().empId(145).name("Siya").salary(30000).address(add)
					.build();
			employeeService.addEmp(emp);
		...
		{
			Address add=Address.builder().city("pune").country("india").build();
			Employee emp=Employee.builder().empId(145).name("Siya").salary(35000).address(add)
					.build();
			employeeService.addEmp(emp);
