...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		Employee e1=new Employee(1,"Rock",19,50000);
		Employee e2=new Employee(3,"Rocckkaa",20,60000);
		Employee e3=new Employee(5,"Roocckkiii",18,30000);
		Employee e4=new Employee(4,"Bockkiii",19,20000);
